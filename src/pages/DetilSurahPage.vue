...
<template>
  <div class="relative min-h-screen bg-cover bg-center min-h-screen w-full mx-auto px-5 py-5" :style="backgroundStyle">
    
      <div 
        v-if="surah" 
        class="bg-white rounded-2xl p-4 md:p-8 h-auto h-[90vh] overflow-y-auto shadow-md"
      >
        <!-- Header -->
